...
import { Download, Ruler, LogOut, Save, Plus, Trash2, Pencil, FolderOpen, ClipboardList, Calculator as CalcIcon, Printer, Share2, Menu, X as CloseIcon, Home as HomeIcon, MessageCircle, Layers, Box, Send } from "lucide-react";
    ...
    <div className="bbs-root min-h-screen flex flex-col">
      ...
      <div className="px-6 pb-10">
        <div className="bbs-card p-6 md:p-8 w-full max-w-sm mx-auto">
          ...
          <p className="text-xs mb-5" style={{ color: "#6E9BBE" }}>Sign in to open your site's BBS records and daily progress log.</p>
          ...
          <button onClick={submit} className="bbs-btn bbs-btn-primary w-full justify-center mt-5 py-3 text-base">Enter Site</button>
