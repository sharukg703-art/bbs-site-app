...
export default function BBSSiteApp() {
  ...
  const shareFile = async () => {
    ...
    try {
      const res = await fetch(downloadReady.url);
      const blob = await res.blob();
      const file = new File([blob], downloadReady.filename, { type: blob.type });
      ...
      if (e && e.name !== "AbortError") {
        ...
        setSaveMsg(`Share failed (${e && e.name ? e.name : "error"}: ${e && e.message ? e.message : "unknown"}) — use the download link instead.`);
