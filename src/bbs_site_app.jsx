  ...
  const shareFile = async () => {
    ...
    try {
      ...
      if (navigator.canShare && navigator.canShare({ files: [file] })) {
        ...
        await navigator.share({ title: downloadReady.filename, url: downloadReady.url });
      } else {
        setSaveMsg("Sharing isn't supported in this browser — use the download link instead.");
        setTimeout(() => setSaveMsg(""), 3500);
      }
    } catch (e) {
      if (e && e.name !== "AbortError") {
        console.error("Share failed:", e);
        setSaveMsg("Share failed — see console for details.");
