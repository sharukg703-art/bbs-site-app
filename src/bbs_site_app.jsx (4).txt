    ...
    <div className="bbs-root min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pt-12 pb-8 text-center">
        ...
        <div className="flex items-center gap-3 mb-3">
          <div className="p-3 rounded-full" style={{ background: "rgba(226,121,61,0.15)", border: "1px solid #E2793D" }}>
            <Ruler size={32} style={{ color: "#F2C14E" }} />
          </div>
        </div>
        <h1 className="bbs-display text-3xl md:text-4xl font-bold mb-2">BBS Site App</h1>
